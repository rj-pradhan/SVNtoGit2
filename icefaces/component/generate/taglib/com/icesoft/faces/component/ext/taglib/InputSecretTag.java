...
public class InputSecretTag extends UIComponentTag {
    ...
    public String getComponentType() {
        return "com.icesoft.faces.HtmlInputSecret";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.Secret";
    }
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (redisplay != null) {
            if (isValueReference(redisplay)) {
                ValueBinding _vb = getFacesContext().getApplication()
                        .createValueBinding(redisplay);
                _component.setValueBinding("redisplay", _vb);
            } else {
                _component.getAttributes()
                        .put("redisplay", Boolean.valueOf(redisplay));
            }
        }
