...
public class OutputStyleTag extends UIComponentTag {

    /**
     * <p>Return the requested component type.</p>
     */
    public String getComponentType() {
        return "com.icesoft.faces.OutputStyleComp";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.style.OutputStyleRenderer";
    }
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (href != null) {
            if (isValueReference(href)) {
                ValueBinding _vb = getFacesContext().getApplication()
                        .createValueBinding(href);
                _component.setValueBinding("href", _vb);
            } else {
                _component.getAttributes().put("href", href);
            }
        }
    }
