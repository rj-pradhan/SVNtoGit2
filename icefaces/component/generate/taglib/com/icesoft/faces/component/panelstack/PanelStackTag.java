...
public class PanelStackTag extends UIComponentTag {
    ...
    public String getComponentType() {
        return "com.icesoft.faces.PanelStack";
    }
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (selectedPanel != null) {
            if (isValueReference(selectedPanel)) {
                ValueBinding _vb = getFacesContext().getApplication()
                        .createValueBinding(selectedPanel);
                _component.setValueBinding("selectedPanel", _vb);
            } else {
                _component.getAttributes().put("selectedPanel", selectedPanel);
            }
        }
        if (style != null) {
