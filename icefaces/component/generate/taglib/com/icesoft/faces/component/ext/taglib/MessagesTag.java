...
public class MessagesTag extends UIComponentTag {
    ...
    public String getComponentType() {
        return "com.icesoft.faces.HtmlMessages";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.Messages";
    }
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (globalOnly != null) {
            if (isValueReference(globalOnly)) {
                ValueBinding _vb = getFacesContext().getApplication()
                        .createValueBinding(globalOnly);
                _component.setValueBinding("globalOnly", _vb);
            } else {
                _component.getAttributes()
                        .put("globalOnly", Boolean.valueOf(globalOnly));
            }
        }
        if (infoClass != null) {
