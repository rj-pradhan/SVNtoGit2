...
public class InputTextareaTag extends UIComponentTag {
    ...
    public String getComponentType() {
        return "com.icesoft.faces.HtmlInputTextarea";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.Textarea";
    }
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (cols != null) {
            if (isValueReference(cols)) {
                ValueBinding _vb = getFacesContext().getApplication()
                        .createValueBinding(cols);
                _component.setValueBinding("cols", _vb);
            } else {
                _component.getAttributes().put("cols", Integer.valueOf(cols));
            }
        }
        if (disabled != null) {
