...
public class PanelGroupTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        ...
        if (dropListener != null) {
            Class[] ca = new Class[]{DropEvent.class};
            MethodBinding mb = FacesContext.getCurrentInstance()
                    .getApplication().createMethodBinding(dropListener, ca);
            _component.getAttributes().put("dropListener", mb);
        }
        if (dragListener != null) {
            Class[] ca = new Class[]{DragEvent.class};
            MethodBinding mb = FacesContext.getCurrentInstance()
                    .getApplication().createMethodBinding(dragListener, ca);
            _component.getAttributes().put("dragListener", mb);
        }
    }
