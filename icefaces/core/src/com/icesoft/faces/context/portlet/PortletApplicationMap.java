...
public class PortletApplicationMap extends AbstractAttributeMap {

    final PortletContext portalContext;

    public PortletApplicationMap(PortletContext portalContext) {
    ...
    protected Object getAttribute(String key) {
        return portalContext.getAttribute(key);
    }
    ...
    protected void setAttribute(String key, Object value) {
        portalContext.setAttribute(key, value);
    }
    ...
    protected void removeAttribute(String key) {
        portalContext.removeAttribute(key);
    }
    ...
    protected Enumeration getAttributeNames() {
        return portalContext.getAttributeNames();
    }
