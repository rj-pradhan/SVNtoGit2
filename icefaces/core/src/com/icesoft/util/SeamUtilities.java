    ...
    private static void loadSeamEnvironment() {
        ...
        try {
            ...
            seamAppendConversationMethodInstance =
                    seamManagerClass.getMethod("appendConversationIdFromRedirectFilter",
...
//            log.info ("Seam environment not detected ");
     ...
     * parameter name, whereas Seam 1.1 uses <code>cid</code>. This method
     * will call the Manager instance to retrieve the name of the
     * current key. This method must only be called when the EventContext
     * is valid (and thus the Manager instance is retrievable).
     * <p>
     * Calling this method also fills in the versionedUrlParam instance
     * variable, used in other methods in this class.  
     *
     * 
     * @return the appropriate tag for the version of Seam Detected
     */
        ...
        try {
            ...
            if (seamConversationIdParameterMethod != null) {
                ...
                returnVal = (String) seamConversationIdParameterMethod.invoke(
                        seamManagerInstance, seamMethodNoArgs);
                log.debug("ConversationIdParameter name =" + returnVal);
