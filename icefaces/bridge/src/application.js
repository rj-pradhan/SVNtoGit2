...
[ Ice.Community ].as(function(This) {
    ...
    This.Application = Object.subclass({
        initialize: function() {
            ...
            window.connection = this.connection = configuration.synchronous ? new Ice.Connection.SyncConnection(ajax, logger, configuration.connection, defaultParameters) : new This.Connection.AsyncConnection(ajax, logger, configuration.connection, defaultParameters);
