...
/**
 * <p>The PulsateBean class backs the Pulsate effect demo.</p>
 */
public class PulsateBean {
    ...
    public PulsateBean(Effects effectsBean) {
    ...
    public String invoke() {
        ...
        effectPanelGroup = new Pulsate(seconds);
        effectCommandButton = new Pulsate(seconds);
        effectInputText = new Pulsate(seconds);
        effectOutputText = new Pulsate(seconds);
        effectSelectOneMenu = new Pulsate(seconds);
        effectSelectManyListBox = new Pulsate(seconds);
