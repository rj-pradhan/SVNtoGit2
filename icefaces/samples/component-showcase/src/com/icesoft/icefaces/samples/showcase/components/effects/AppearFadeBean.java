...
/**
 * <p>The AppearFadeBean backs the Appear & Fade effects demo.</p>
 */
public class AppearFadeBean {
    ...
    public AppearFadeBean(Effects effectsBean) {
    ...
    public String appearAction() {
        ...
        effectInputText = new Appear(to, from);
        effectCommandButton = new Appear(to, from);
        effectOutputText = new Appear(to, from);
        effectSelectOneMenu = new Appear(to, from);
        effectSelectManyListBox = new Appear(to, from);
    ...
    public String fadeAction() {
        ...
        effectInputText = new Fade(from, to);
        effectCommandButton = new Fade(from, to);
        effectOutputText = new Fade(from, to);
        effectSelectOneMenu = new Fade(from, to);
        effectSelectManyListBox = new Fade(from, to);
