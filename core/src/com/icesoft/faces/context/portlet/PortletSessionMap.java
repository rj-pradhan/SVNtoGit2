...
package com.icesoft.faces.context.portlet;
...
public class PortletSessionMap extends AbstractAttributeMap {
    private final PortletSession portletSession;

    /* PortletSession.PORTLET_SCOPE or PortletSession.APPLICATION_SCOPE*/
    private final int scope;

    public PortletSessionMap(PortletSession portletSession) {
        this(portletSession, PortletSession.PORTLET_SCOPE);
    }

    public PortletSessionMap(PortletSession portletSession, int scope) {
    ...
    protected Object getAttribute(String key) {
        return portletSession.getAttribute(key, scope);
    }
    ...
    protected void setAttribute(String key, Object value) {
        portletSession.setAttribute(key, value, scope);
    }
    ...
    protected void removeAttribute(String key) {
        portletSession.removeAttribute(key, scope);
    }
